...
| Commit | Description |
|---|---|
| `317cb71` | fix: panel-estudiante — título del card azul muestra "Next Club" o "Next Session" según el tipo real del próximo evento (antes era siempre "Next Session" hardcodeado) |
