...
export enum StudentPermission {
  ...
  // Academia
  VER_ASISTENCIA = 'STUDENT.ACADEMIA.VER_ASISTENCIA',
  NIVELACION_HISTORIAL = 'STUDENT.ACADEMIA.NIVELACION_HISTORIAL',
  CAMBIO_ACADEMICO = 'STUDENT.ACADEMIA.CAMBIO_ACADEMICO',
  ...
  // Las dos cajas de texto del modal "Detalles de la Clase" se controlan en DOS
  // niveles: el permiso base deja VER la caja (sólo lectura) y el `…_EDITAR`
  // deja escribir en ella. Antes la edición estaba clavada por rol
  // (SUPER_ADMIN/COORDINADOR_ACADEMICO), así que cambiar permisos no la movía.
  ANOTACION_ADVISOR = 'STUDENT.ACADEMIA.ANOTACION_ADVISOR',
  ANOTACION_ADVISOR_EDITAR = 'STUDENT.ACADEMIA.ANOTACION_ADVISOR.EDITAR',
  COMENTARIOS_ESTUDIANTE = 'STUDENT.ACADEMIA.COMENTARIOS_ESTUDIANTE',
  COMENTARIOS_ESTUDIANTE_EDITAR = 'STUDENT.ACADEMIA.COMENTARIOS_ESTUDIANTE.EDITAR',
  ...
  APROBAR_WELCOME = 'STUDENT.ACADEMIA.APROBAR_WELCOME',
  MOVIMIENTO_ACADEMICO = 'STUDENT.ACADEMIA.MOVIMIENTO_ACADEMICO',
...
export enum AcademicoPermission {
  ...
  GUIA_EDITAR = 'ACADEMICO.GUIA.EDITAR', // editar info del guía (ver = LISTA_ADVISORS_VER)
...
export enum ServicioPermission {
  ...
  WELCOME_REAGENDAR = 'SERVICIO.WELCOME.REAGENDAR',
...
export enum MantenimientoPermission {
  ...
  IMPORTAR_CONTRATO_PDF = 'MANTENIMIENTO.CONTRATOS.IMPORTAR_PDF',
