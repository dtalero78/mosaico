...
export const ROUTE_PERMISSIONS: Record<string, Permission[]> = {
  ...
  '/dashboard/academic/reporte-academico': [
    'ACADEMICO.REPORTE_ACADEMICO.VER' as Permission,
  ],
  ...
  '/dashboard/academic/lista-usuarios': [
    'ACADEMICO.LISTA_USUARIOS.VER' as Permission,
  ],
  '/dashboard/academic/actualizar-material/imagenes': [
    'ACADEMICO.MATERIAL.ACTUALIZAR' as Permission,
  ],
  '/dashboard/academic/actualizar-material/videos': [
    'ACADEMICO.MATERIAL.ACTUALIZAR' as Permission,
  ],
  ...
  '/dashboard/academic/actualizar-material/importar-evaluaciones': [
    'ACADEMICO.MATERIAL.ACTUALIZAR' as Permission,
  ],
  ...
  '/dashboard/academic/festivos': [
    'ACADEMICO.FESTIVOS.GESTION' as Permission,
  ],
  ...
  '/admin/booking': [
    'MANTENIMIENTO.USUARIOS.BOOKING' as Permission,
  ],
