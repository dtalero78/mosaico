...
const getNavigation = (userEmail: string, userRole: string) => [
    ...
    children: [
      ...
      // propio permiso (ver pagePermissions); SUPER_ADMIN/ADMIN ven todo (hasFullAccess).
      {
        name: 'Guías', isSubmenu: true, children: [
          ...
          { name: 'Casos Usuarios', href: '/dashboard/academic/casos-usuarios', newTab: true },
        ],
      },
      ...
      { name: 'Tipos de Curso', href: '/dashboard/academic/tipos-curso', newTab: true },
  ...
  },
  {
    ...
    children: [
      ...
      { name: 'Aprobados',              href: '/dashboard/aprobacion/aprobados' },
...
export default function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  const pagePermissions: Record<string, Permission[]> = {
    ...
    '/dashboard/academic/tipos-curso': [
      AcademicoPermission.TIPOS_CURSO_GESTION,
    ],
    ...
    '/dashboard/academic/lista-usuarios': [
      AcademicoPermission.LISTA_USUARIOS_VER,
    ],
    '/dashboard/academic/reporte-academico': [
      AcademicoPermission.REPORTE_ACADEMICO_VER,
    ],
    ...
    '/dashboard/academic/casos-usuarios': [
      AcademicoPermission.CASOS_USUARIOS_VER,
    ],
    '/panel-advisor': [
