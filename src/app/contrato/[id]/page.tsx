...
export default function ContratoPublicoPage() {
  ...
  const handleSendOtp = async () => {
    if (!numeroDocumento.trim()) {
      setOtpError('Ingresa tu numero de R.U.N.')
      return
    }
    try {
      setSendingOtp(true)
            ...
            <div className="flex-1">
              ...
              <div className="mt-2 grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs text-blue-700">
                {consentStatus.consent.numeroDocumento && (
                  <div><span className="font-medium">R.U.N.:</span> {consentStatus.consent.numeroDocumento}</div>
                )}
      ...
      {pageState === 'DOCUMENT_ENTRY' && (
        <div className="bg-white rounded-lg border border-gray-200 p-4 sm:p-6">
          ...
          <p className="text-sm text-gray-500 mb-4">
            Ingresa tu numero de R.U.N. para recibir un codigo de verificacion por WhatsApp.
          </p>
