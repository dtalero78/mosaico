  ...
  return (
    <div className="p-6 max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <button
          type="button"
          onClick={() => openTab('/dashboard/academic/actualizar-material/importar-evaluaciones')}
          className="flex flex-col items-center justify-center gap-4 p-10 bg-white border-2 border-gray-200 rounded-2xl shadow-sm hover:border-orange-500 hover:shadow-md transition-all text-left group"
        >
          ...
          <div className="text-center">
            <div className="text-lg font-semibold text-gray-900 group-hover:text-orange-600 transition-colors">Importar Evaluaciones</div>
            <div className="text-sm text-gray-500 mt-1">Preguntas de evaluación desde CSV</div>
          </div>
        </button>
