...
export const PERMISSIONS_CATALOG: PermissionDefinition[] = [
  ...
  },
  {
    ...
    module: Module.STUDENT,
    section: 'Tab Académica > Modal Clase',
    name: 'Sección "Anotaciones Académicas" (ver)',
    description: 'Muestra en el modal "Detalles de la Clase" la caja con las anotaciones internas del área académica sobre el usuario — el usuario no las ve. Sin el permiso de edición, la caja queda en SOLO LECTURA.',
  },
  {
    code: StudentPermission.ANOTACION_ADVISOR_EDITAR,
    module: Module.STUDENT,
    section: 'Tab Académica > Modal Clase',
    name: '↳ Editar "Anotaciones Académicas"',
    description: 'Permite ESCRIBIR en las Anotaciones Académicas. Requiere además el permiso de ver la sección; sin éste, la caja se muestra en solo lectura.',
  },
  {
    code: StudentPermission.COMENTARIOS_ESTUDIANTE,
    module: Module.STUDENT,
    section: 'Tab Académica > Modal Clase',
    name: 'Sección "Comentarios para el Usuario" (ver)',
    description: 'Muestra en el modal "Detalles de la Clase" los comentarios que SÍ ve el usuario en su panel. Sin el permiso de edición, la caja queda en SOLO LECTURA.',
  },
  {
    code: StudentPermission.COMENTARIOS_ESTUDIANTE_EDITAR,
    module: Module.STUDENT,
    section: 'Tab Académica > Modal Clase',
    name: '↳ Editar "Comentarios para el Usuario"',
    description: 'Permite ESCRIBIR los comentarios que verá el usuario. Requiere además el permiso de ver la sección; sin éste, la caja se muestra en solo lectura.',
  },
  {
