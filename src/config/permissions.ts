...
export const PERMISSIONS_CATALOG: PermissionDefinition[] = [
  ...
  },
  {
    ...
    module: Module.STUDENT,
    section: 'Tab Académica > Modal Clase',
    name: 'Sección "Anotaciones Académicas"',
    description: 'Campo de texto del modal "Detalles de la Clase" con las anotaciones internas del área académica sobre el usuario — no las ve el usuario.',
  },
  {
    code: StudentPermission.COMENTARIOS_ESTUDIANTE,
    module: Module.STUDENT,
    section: 'Tab Académica > Modal Clase',
    name: 'Sección "Comentarios para el Usuario"',
    description: 'Comentarios del modal "Detalles de la Clase" que SÍ ve el usuario en su panel.',
  },
  {
